...
const (
	DaemonService_Register_FullMethodName  = "/daemon.v1.DaemonService/Register"
	DaemonService_HeartBeat_FullMethodName = "/daemon.v1.DaemonService/HeartBeat"
)
...
func (c *daemonServiceClient) Register(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*RegisterResponse, error) {
	...
	err := c.cc.Invoke(ctx, DaemonService_Register_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daemonServiceClient) HeartBeat(ctx context.Context, in *HeartBeatRequest, opts ...grpc.CallOption) (*HeartBeatResponse, error) {
	...
	err := c.cc.Invoke(ctx, DaemonService_HeartBeat_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
