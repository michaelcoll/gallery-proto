...
type GetPhotosRequest struct {
	...
	Page     uint32 `protobuf:"varint,1,opt,name=page,proto3" json:"page,omitempty"`                         // the page number
	PageSize uint32 `protobuf:"varint,2,opt,name=page_size,json=pageSize,proto3" json:"page_size,omitempty"` // the page size
}
...
func (x *GetPhotosRequest) GetPage() uint32 {
	if x != nil {
		return x.Page
	}
	return 0
...
func (x *GetPhotosRequest) GetPageSize() uint32 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
var file_photo_v1_photo_proto_rawDesc = []byte{
	...
	0x69, 0x6d, 0x65, 0x12, 0x10, 0x0a, 0x03, 0x69, 0x73, 0x6f, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0d,
	...
	0x5f, 0x64, 0x69, 0x6d, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0d,
